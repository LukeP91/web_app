...
describe 'Admin edit', type: :feature do
  context 'User with admin priviliges' do
    ...
    scenario 'can edit users from his organization' do
      ...
      app.admin_edit_page.form.email_field.set modified_user[:email]
      app.admin_edit_page.form.first_name_field.set modified_user[:first_name]
      app.admin_edit_page.form.last_name_field.set modified_user[:last_name]
      app.admin_edit_page.form.gender_field.select modified_user[:gender]
      app.admin_edit_page.form.age_field.select modified_user[:age]
      app.admin_edit_page.form.interests_field.select 'test1'
      app.admin_edit_page.form.confirm_button.click
